...
The riscv-binutils git submodule should be kept in sync with the
freedom-binutils-metal repo to make sure they do not drift apart.
...
### To build the tools:
    ...
    $ git clone git@github.com:sifive/freedom-trace-decoder.git
    $ cd freedom-trace-decoder
